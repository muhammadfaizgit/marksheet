void main() {
 ...
 // print(sn2 + "       " +  secstdname +"    " + ssn + "     ${totalmarks}" + "          " + "$result" + "        "+ "$secpercentage");
  ...
  var ftsni = 60;
  var ftsnis = " 78    ";
  var ftsn = ftsnms + ftsnes + ftsnus + ftsncs + ftsnis;
  var ftresult = ftsnm + ftsne + ftsnu + ftsnc + ftsni;
  var fttotalmarks = 500;
  var ftpercentage = ftresult/fttotalmarks*100;
 // print(sn4 + "       " +  ftstdname +"    " + ftsn + "     ${fttotalmarks}" + "          " + "$ftresult" + "        "+ "$ftpercentage" + "A1");
 
  if(ftpercentage>=90){
    print(sn4 + "       " +  ftstdname +"    " + ftsn + "     ${fttotalmarks}" + "          " + "$ftresult" + "        "+ "$ftpercentage" + "A1");
  }else if(ftpercentage>=80){
    print(sn4 + "       " +  ftstdname +"    " + ftsn + "     ${fttotalmarks}" + "          " + "$ftresult" + "        "+ "$ftpercentage" + "A+");
  }else if(ftpercentage>=70){
    print(sn4 + "       " +  ftstdname +"    " + ftsn + "     ${fttotalmarks}" + "          " + "$ftresult" + "        "+ "$ftpercentage" + "A");
  }else if(ftpercentage>=60){
    print(sn4 + "       " +  ftstdname +"    " + ftsn + "     ${fttotalmarks}" + "          " + "$ftresult" + "        "+ "$ftpercentage" + "B");
  }else{
    print(sn4 + "       " +  ftstdname +"    " + ftsn + "     ${fttotalmarks}" + "          " + "$ftresult" + "        "+ "$ftpercentage" + "    C");
